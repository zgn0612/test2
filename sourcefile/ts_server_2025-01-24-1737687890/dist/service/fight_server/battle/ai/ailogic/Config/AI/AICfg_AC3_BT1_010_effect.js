...
class AICfg_AC3_BT1_010_effect extends AIcfgBase_1.AIcfgBase {
    GetAITreeRoot(root, playerid) {
        ...
        let node3 = new AIEffect_SortSelectCardWithCardNumber_1.AIEffect_SortSelectCardWithCardNumber(AIRoot);
        node3.nParam1 = 0;
        node3.sParam1 = "BT1-085";
        ...
        node3.nParam2 = 0;
        let node4 = new AIEffect_ISChooseCard_1.AIEffect_ISChooseCard(AIRoot);
        node4.nParam1 = 11501011;
        node4.sParam1 = "None";
...
exports.default = AICfg_AC3_BT1_010_effect;
//# sourceMappingURL=AICfg_AC3_BT1_010_effect.js.map
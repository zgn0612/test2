...
class AICfg_AC3_P_035_effect extends AIcfgBase_1.AIcfgBase {
    GetAITreeRoot(root, playerid) {
        ...
        node3.nParam2 = 101;
        let node4 = new AIEffect_SortSelectCardNumberCheckHand_WithLv_1.AIEffect_SortSelectCardNumberCheckHand_WithLv(AIRoot);
        node4.nParam1 = 0;
        node4.sParam1 = "ST1-11|BT1-025|ST1-09|BT1-021|ST1-06|ST1-07|ST7-06|ST1-03|BT1-010|ST7-02|ST1-01";
        ...
        node6.eArea1 = ADefine_1.AiFilterArea.Self_HAND_BATTLE_HATCH;
...
exports.default = AICfg_AC3_P_035_effect;
//# sourceMappingURL=AICfg_AC3_P_035_effect.js.map
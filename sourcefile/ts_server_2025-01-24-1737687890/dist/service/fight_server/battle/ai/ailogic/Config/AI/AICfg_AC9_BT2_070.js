...
class AICfg_AC9_BT2_070 extends AIcfgBase_1.AIcfgBase {
    GetAITreeRoot(root, playerid) {
        ...
        node28.nParam2 = 0;
        let node29 = new AIAction_Attack_Player_1.AIAction_Attack_Player(AIRoot);
        node29.priority = 985;
        let node30 = new AICtrl_Sequece_1.AICtrl_Sequece(AIRoot);
        let node31 = new AICon_CanAttack_1.AICon_CanAttack(AIRoot);
        node31.nParam1 = 0;
        node31.sParam1 = "None";
        ...
        node32.nParam1 = 0;
        node32.sParam1 = "enemy1";
        node32.eCompare1 = ADefine_1.AiFilterCompare.None;
        node32.eArea1 = ADefine_1.AiFilterArea.Opp_Battle;
        ...
        node33.nParam1 = 0;
        node33.sParam1 = "enemy1";
        node33.eCompare1 = ADefine_1.AiFilterCompare.LESS_EQUAL;
        node33.eArea1 = ADefine_1.AiFilterArea.None;
        node33.containerType = ADefine_1.AiFilterContainerType.CURRENT_CARD_DP_CHECK;
        node33.sParam2 = "None";
        ...
        node36.nParam2 = 0;
        let node37 = new AIAction_Attack_1.AIAction_Attack(AIRoot);
        node37.priority = 751;
...
exports.default = AICfg_AC9_BT2_070;
//# sourceMappingURL=AICfg_AC9_BT2_070.js.map
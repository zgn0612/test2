...
class AICfg_AC9_BT6_077_effect extends AIcfgBase_1.AIcfgBase {
    GetAITreeRoot(root, playerid) {
        ...
        node3.nParam2 = 1;
        let node4 = new AICon_Container_Sort_1.AICon_Container_Sort(AIRoot);
        node4.nParam1 = 1;
        ...
        node4.sParam2 = "BT6-077|BT6-105|BT2-110|BT6-109|ST6-16|BT7-072|BT2-072|BT6-077|BT7-069|BT3-077|BT2-070|BT6-068|BT2-068|BT2-090|BT6-065|BT6-060|BT2-083|BT6-112 ";
        node4.eBattleSatate = ADefine_1.AiCardBattleState.None;
        node4.eCardType = ADefine_1.AiCardType.None;
        node4.nParam2 = 0;
        let node5 = new AIEffect_ContainerToEffect_1.AIEffect_ContainerToEffect(AIRoot);
        node5.nParam1 = 0;
...
exports.default = AICfg_AC9_BT6_077_effect;
//# sourceMappingURL=AICfg_AC9_BT6_077_effect.js.map
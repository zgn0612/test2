...
class AICfg_BT5_010 extends AIcfgBase_1.AIcfgBase {
    GetAITreeRoot(root, playerid) {
        ...
        node7.nParam2 = 0;
        let node8 = new AIAction_EvoCard_1.AIAction_EvoCard(AIRoot);
        node8.priority = 570;
        let node9 = new AICon_CheckPlayerCost_1.AICon_CheckPlayerCost(AIRoot);
        node9.nParam1 = 2;
        node9.sParam1 = "None";
        ...
        node12.nParam1 = 0;
        node12.sParam1 = "hatch";
        node12.eCompare1 = ADefine_1.AiFilterCompare.None;
        node12.eArea1 = ADefine_1.AiFilterArea.Self_Hatch;
        ...
        node23.sParam2 = "ST7-02|P-009|ST1-03";
        ...
        node30.sParam2 = "ST7-02|P-009|ST1-03";
        ...
        node25.AddChildNode(node32);
        return AIRoot;
    }
}
exports.default = AICfg_BT5_010;
//# sourceMappingURL=AICfg_BT5_010.js.map
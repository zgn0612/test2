...
class EC_BT1_079_O_1 extends DtEnhanceEffectCreatorts_1.default {
    SetEffect() {
    ...
    OnCommonAreaSetFilter(mcFliter) {
        ...
        mcFliter.SetFilter(new DtCardFilter_Custom_1.DtCardFilter_Custom(this, (card) => {
            return card.HasEffect(DtEnum_1.EFFECT_NAME.BLOCKER) == false;
        }));
    }
...
exports.default = EC_BT1_079_O_1;
//# sourceMappingURL=EC_BT1_079_O_1.js.map
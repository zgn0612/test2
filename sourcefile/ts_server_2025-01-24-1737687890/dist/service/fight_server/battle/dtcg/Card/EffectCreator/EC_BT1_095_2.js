...
class EC_BT1_095_2 extends DtEnhanceEffectCreatorts_1.default {
    SetEffect() {
    ...
    OnCommonAreaSetOperate(mcOperate) {
        ...
        mcOperate.SetOperate(new DtCardOperate_SpecialOperate_1.DtCardOperate_SpecialOperate(this, (card) => {
            this.CreateEffectTo(new EC_BT1_095_2_ADD(), card, false);
        }, DtCardOperate_SpecialOperate_1.DtSpecialOpType.ADD_SKILL_BUFF));
    }
}
exports.default = EC_BT1_095_2;
class EC_BT1_095_2_ADD extends DtEffectCreator_1.DtEffectCreator {
    SetEffect() {
        let effect = this.CreateTimeEffectToCard(this.parent, DtEnum_1.DtBuffDurationType.RoundOver, 1);
        this.SetBlockEffect(effect);
    }
}
//# sourceMappingURL=EC_BT1_095_2.js.map
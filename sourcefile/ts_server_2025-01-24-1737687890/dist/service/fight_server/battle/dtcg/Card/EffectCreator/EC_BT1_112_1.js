...
class EC_BT1_112_1 extends DtEnhanceEffectCreatorts_1.default {
    SetEffect() {
    ...
    OnCommonAreaSetOperate(mcOperate) {
        mcOperate.SetOperate(new DtCardOperate_SpecialOperate_1.DtCardOperate_SpecialOperate(this, (card) => {
            this.CreateEffectTo(new EC_BT1_112_1_Add(), card, false);
        }, DtCardOperate_SpecialOperate_1.DtSpecialOpType.ADD_SKILL_BUFF));
    }
}
exports.default = EC_BT1_112_1;
class EC_BT1_112_1_Add extends DtEffectCreator_1.DtEffectCreator {
    SetEffect() {
        ...
        effect.SetTriggerCondition(this.GetBattleDestroyDigimonAndSelfAlive(DtEnum_1.DtEffectRoundValid.Both));
...
//# sourceMappingURL=EC_BT1_112_1.js.map
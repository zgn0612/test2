...
class EC_BT2_084_1 extends DtEffectCreator_1.DtEffectCreator {
    SetEffect() {
        ...
        ctri.SetAtkCardCon(DtEnum_1.DtCardType.Monster, DtEnum_1.DtCardColor.Red, DtEnum_1.DtSkillTargetToPlayer.Self);
    ...
    Effect(effect) {
        ...
        effect.AddInheritBuffTo(new DtBuffChangeDP_1.DtBuffChangeDP(2000).SetBuffDurationType(DtEnum_1.DtBuffDurationType.RoundOver), msg.atkCard);
        return DtEffect_1.DtEffectResult.Next;
    }
}
exports.default = EC_BT2_084_1;
//# sourceMappingURL=EC_BT2_084_1.js.map
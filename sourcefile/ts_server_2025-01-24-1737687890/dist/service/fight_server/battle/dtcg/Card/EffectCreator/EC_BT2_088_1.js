...
class EC_BT2_088_1 extends DtEffectCreator_1.DtEffectCreator {
    SetEffect() {
    ...
    BuffCon(buff, card) {
        if (card.NameIs(DtCardDigimonType_1.DtCardDigimonType.name_type_10105)) {
            return true;
        }
        return false;
    }
}
exports.default = EC_BT2_088_1;
//# sourceMappingURL=EC_BT2_088_1.js.map
...
class EC_BT4_023_1 extends DtGroupBrowseCardsCreator_1.default {
    SetEffect() {
        let effect = this.CreateNewBasicEffect(DtEffectType_1.DtEffectType.OnPlay);
        this.SetCommonBrowseFromDeckThenBottom(effect, 3, 2, (skill, idx) => {
            if (idx == 0) {
...
exports.default = EC_BT4_023_1;
//# sourceMappingURL=EC_BT4_023_1.js.map
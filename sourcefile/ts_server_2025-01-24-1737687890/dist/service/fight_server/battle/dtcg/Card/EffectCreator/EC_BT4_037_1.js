...
class EC_BT4_037_1 extends DtEnhanceEffectCreatorts_1.default {
    SetEffect() {
        let effect = this.GetNewEffect();
        effect.SetTriggerType(DtEffectType_1.DtEffectType.OnPlay);
        effect.SetEffectActivateAsk();
        effect.SetCondition(this.Con);
        effect.SetEffect(this.EffectDiscardDefense, null);
        this.skill(effect);
    }
    Con(effect) {
        return this.GetPlayer().areaDefense.CardCount() > 0;
    }
    EffectDiscardDefense() {
...
exports.default = EC_BT4_037_1;
//# sourceMappingURL=EC_BT4_037_1.js.map
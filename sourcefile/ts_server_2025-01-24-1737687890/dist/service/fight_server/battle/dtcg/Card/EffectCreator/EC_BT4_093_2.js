...
class EC_BT4_093_2 extends DtEnhanceEffectCreatorts_1.default {
    SetEffect() {
    ...
    Con(effect) {
        return this.GetOppPlayer().areaHand.CardCount() >= 8 && this.parent.cardBattleState == DtEnum_1.DtCardBattleState.Activate;
    }
    Skill(effect) {
        ...
        skill.SetFilter(new DtCardFilter_NameIs_1.DtCardFilter_NameIs(DtCardDigimonType_1.DtCardDigimonType.name_type_10437));
        skill.SetOperate(new DtCardOperate_ChangeState_1.DtCardOperate_ChangeState(DtEnum_1.DtCardBattleState.Activate));
    }
}
exports.default = EC_BT4_093_2;
//# sourceMappingURL=EC_BT4_093_2.js.map
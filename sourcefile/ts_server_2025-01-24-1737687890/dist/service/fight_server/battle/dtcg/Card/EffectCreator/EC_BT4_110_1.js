...
class EC_BT4_110_1 extends DtEnhanceEffectCreatorts_1.default {
    SetEffect() {
    ...
    OnCommonAreaSetFilter(mcFliter) {
        ...
        mcFliter.SetFilter(new DtCardFilter_Custom_1.DtCardFilter_Custom(this, (card) => {
            let count = this.GetPlayer().areaInBattle.GetCountWithMeetCondition((card) => {
                return card.CardTypeIs(DtEnum_1.DtCardType.Monster) && card.FeatureIs(DtCardDigimonType_1.DtCardDigimonType.type_139);
            });
            return card.GetConfigCost() <= 3 + count;
        }));
    }
...
exports.default = EC_BT4_110_1;
//# sourceMappingURL=EC_BT4_110_1.js.map
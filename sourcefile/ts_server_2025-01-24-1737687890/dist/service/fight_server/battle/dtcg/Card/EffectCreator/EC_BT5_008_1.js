...
class EC_BT5_008_1 extends DtEffectCreator_1.DtEffectCreator {
    SetEffect() {
    ...
    buffCon(buff, card) {
        if (card.NameIs(DtCardDigimonType_1.DtCardDigimonType.name_type_10675, true) && card != this.parent) {
            return 3000;
        }
        return 0;
    }
}
exports.default = EC_BT5_008_1;
//# sourceMappingURL=EC_BT5_008_1.js.map
...
class EC_BT5_067_1 extends DtEffectCreator_1.DtEffectCreator {
    SetEffect() {
    ...
    BuffCon(buff, card) {
        ...
        if (card.NameIs(DtCardDigimonType_1.DtCardDigimonType.name_type_10255, true)) {
            return 4;
        }
        return -1;
    }
}
exports.default = EC_BT5_067_1;
//# sourceMappingURL=EC_BT5_067_1.js.map
...
class EC_BT5_070_2 extends DtEnhanceBaoLieEffectCreatorts_1.default {
    SetEffect() {
        ...
        this.Skill(effect);
        effect.SetEffect(this.EffectDiscardDef, null).type = DtSkillBase_1.DtSkillRunType.Perv_SUCCESS_Then_Over;
    }
    Skill(effect) {
...
exports.default = EC_BT5_070_2;
//# sourceMappingURL=EC_BT5_070_2.js.map
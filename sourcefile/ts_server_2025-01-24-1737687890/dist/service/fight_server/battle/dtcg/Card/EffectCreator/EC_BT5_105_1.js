...
class EC_BT5_105_1 extends DtEnhanceEffectCreatorts_1.default {
    SetEffect() {
    ...
    Effect() {
        this.GetOppPlayer().areaInBattle.ForeachCards((card) => {
            if (card.GetConfigCost() <= 3 && card.CardTypeIs(DtEnum_1.DtCardType.Monster)) {
...
exports.default = EC_BT5_105_1;
//# sourceMappingURL=EC_BT5_105_1.js.map
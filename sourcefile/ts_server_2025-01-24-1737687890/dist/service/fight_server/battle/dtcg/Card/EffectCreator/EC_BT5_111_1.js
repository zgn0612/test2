...
class EC_BT5_111_1 extends DtEffectCreator_1.DtEffectCreator {
    SetEffect() {
    ...
    BuffCon(buff, card) {
        ...
        if (card.NameIs(DtCardDigimonType_1.DtCardDigimonType.name_type_10008)) {
            return 3;
        }
        return -1;
    }
}
exports.default = EC_BT5_111_1;
//# sourceMappingURL=EC_BT5_111_1.js.map
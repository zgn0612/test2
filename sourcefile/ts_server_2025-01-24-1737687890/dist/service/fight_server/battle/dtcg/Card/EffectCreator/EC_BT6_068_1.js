...
class EC_BT6_068_1 extends DtEnhanceEffectCreatorts_1.default {
    SetEffect() {
    ...
    Skill2(effect) {
        ...
        skill.SetFilter(new DtCardFilter_FeatureIs_1.DtCardFilter_FeatureIs(DtCardDigimonType_1.DtCardDigimonType.type_123, DtCardDigimonType_1.DtCardDigimonType.type_138));
        skill.SetOperate(new DtCardOperate_MoveTo_Hand_1.DtCardOperate_MoveTo_Hand());
    }
}
exports.default = EC_BT6_068_1;
//# sourceMappingURL=EC_BT6_068_1.js.map
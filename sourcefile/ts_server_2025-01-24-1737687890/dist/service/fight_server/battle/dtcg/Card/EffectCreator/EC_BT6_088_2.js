...
class EC_BT6_088_2 extends DtEnhanceEffectCreatorts_1.default {
    battleCard;
    evoCard;
    SetEffect() {
        ...
        skill.GetMachineFilter().SetFilter(new DtCardFilter_NameIs_1.DtCardFilter_NameIs(DtCardDigimonType_1.DtCardDigimonType.name_type_10009, true));
        skill.GetMachineFilter().SetFilter(new DtCardFilter_CardType_1.DtCardFilter_CardType(DtEnum_1.DtCardType.Monster));
        skill.GetMachineFilter().SetFilter(new DtCardFilter_CardColor_1.DtCardFilter_CardColor(DtEnum_1.DtCardColor.Blue));
    ...
    Effect2(effect) {
        ...
        skill.GetMachineFilter().SetFilter(new DtCardFilter_NameIs_1.DtCardFilter_NameIs(DtCardDigimonType_1.DtCardDigimonType.name_type_10753, true));
        skill.GetMachineFilter().SetFilter(new DtCardFilter_CardType_1.DtCardFilter_CardType(DtEnum_1.DtCardType.Monster));
    ...
    Condition() {
        ...
        let battlehasYa = this.GetPlayer().areaInBattle.CheckWithCondition((card) => {
            return card.NameIs(DtCardDigimonType_1.DtCardDigimonType.name_type_10009, true);
        });
        if (battlehasYa == false) {
            return false;
        }
        let handhasYong = this.GetPlayer().areaHand.CheckWithCondition((card) => {
            return card.NameIs(DtCardDigimonType_1.DtCardDigimonType.name_type_10753, true);
        });
        return handhasYong;
    }
    EffectAfter(effect) {
        ...
        if (this.GetPlayer().areaDefense.CardCount() >= 1) {
            this.CreateEffectTo(new EC_BT6_088_2_ADD(), this.evoCard, false);
        }
        return DtEffect_1.DtEffectResult.Next;
    }
}
exports.default = EC_BT6_088_2;
class EC_BT6_088_2_ADD extends DtEffectCreator_1.DtEffectCreator {
    SetEffect() {
...
//# sourceMappingURL=EC_BT6_088_2.js.map
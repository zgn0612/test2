...
class EC_BT6_098_1 extends DtEnhanceEffectCreatorts_1.default {
    SetEffect() {
    ...
    EffectSetEffect(effect) {
        let opMonsterCount = this.GetOppPlayer().areaInBattle.GetCountWithMeetCondition((card) => { return card.CardTypeIs(DtEnum_1.DtCardType.Monster); });
        if (opMonsterCount >= 3) {
...
exports.default = EC_BT6_098_1;
//# sourceMappingURL=EC_BT6_098_1.js.map
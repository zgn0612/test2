...
class EC_BT7_008_1 extends DtGroupBrowseCardsCreator_1.default {
    SetEffect() {
        ...
        this.SetCommonBrowseFromDeckThenBottom(effect, 4, 1, (skill, idx) => {
            skill.SetFilter(new DtCardFilter_Custom_1.DtCardFilter_Custom(this, (card) => {
                ...
                if (card.NameIs(DtCardDigimonType_1.DtCardDigimonType.name_type_10763, true)) {
                    return true;
                }
...
exports.default = EC_BT7_008_1;
//# sourceMappingURL=EC_BT7_008_1.js.map
...
class EC_BT7_011_2 extends DtEnhanceEffectCreatorts_1.default {
    SetEffect() {
    ...
    Con() {
        let con = this.parent.CheckOriginListWithCondition((card) => {
            return card.FeatureIs(DtCardDigimonType_1.DtCardDigimonType.type_505) || card.NameIs(DtCardDigimonType_1.DtCardDigimonType.name_type_10763, true);
        });
        return con;
    }
...
exports.default = EC_BT7_011_2;
//# sourceMappingURL=EC_BT7_011_2.js.map
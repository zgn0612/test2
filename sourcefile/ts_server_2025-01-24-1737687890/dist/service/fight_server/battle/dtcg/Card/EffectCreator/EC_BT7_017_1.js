...
class EC_BT7_017_1 extends DtDigimonPersistenceBuff_1.default {
    SetEffect() {
    ...
    BuffCon(buff, card) {
        ...
        if (card.NameIs(DtCardDigimonType_1.DtCardDigimonType.name_type_10088, true)) {
            return 1;
        }
        return -1;
    }
}
exports.default = EC_BT7_017_1;
//# sourceMappingURL=EC_BT7_017_1.js.map
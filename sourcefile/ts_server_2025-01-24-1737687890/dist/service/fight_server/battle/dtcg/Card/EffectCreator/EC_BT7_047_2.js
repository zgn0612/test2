...
class EC_BT7_047_2 extends DtEnhanceEffectCreatorts_1.default {
    SetEffect() {
    ...
    Con() {
        return this.parent.CheckOriginListWithCondition((card) => {
            return card.NameIs(DtCardDigimonType_1.DtCardDigimonType.name_type_10860, true) || card.FeatureIs(DtCardDigimonType_1.DtCardDigimonType.type_505);
        });
    }
...
exports.default = EC_BT7_047_2;
//# sourceMappingURL=EC_BT7_047_2.js.map
...
class EC_BT7_059_1 extends DtGroupBrowseCardsCreator_1.default {
    SetEffect() {
        ...
        this.SetCommonBrowseFromDeckThenBottom(effect, 5, 2, (skl, idx) => {
            skl.SetFilter(new DtCardFilter_NameIs_1.DtCardFilter_NameIs(DtCardDigimonType_1.DtCardDigimonType.name_type_10589));
            skl.SetOperate(new DtCardOperate_MoveTo_Hand_1.DtCardOperate_MoveTo_Hand());
        });
    }
}
exports.default = EC_BT7_059_1;
//# sourceMappingURL=EC_BT7_059_1.js.map
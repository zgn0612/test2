...
const DtCardFilter_HasOriginEffect_1 = require("../Skill/DtSkillCardFilter/DtCardFilter_HasOriginEffect");
const DtCardOperate_PlayCard_1 = require("../Skill/DtSkillCardOperate/DtCardOperate_PlayCard");
class EC_BT7_080_1 extends DtEnhanceEffectCreatorts_1.default {
    SetEffect() {
    ...
    OnCommonAreaSetFilter(mcFliter) {
        ...
        mcFliter.SetFilter(new DtCardFilter_HasOriginEffect_1.DtCardFilter_HasOriginEffect());
    }
    OnCommonAreaSetOperate(mcOperate) {
        mcOperate.SetOperate(new DtCardOperate_PlayCard_1.DtCardOperate_PlayCard(false, true));
    }
}
exports.default = EC_BT7_080_1;
//# sourceMappingURL=EC_BT7_080_1.js.map
...
class EC_BT7_082_1 extends DtEnhanceEffectCreatorts_1.default {
    SetEffect() {
        let effect = this.GetNewEffect();
        effect.SetTriggerType(DtEffectType_1.DtEffectType.OnPlay);
        this.Skill1(effect);
        let reeff = effect.SetEffect(this.Restore, null);
        reeff.type = DtSkillBase_1.DtSkillRunType.Perv_Fail_Then_Over;
    ...
    Skill1(effect) {
        ...
        skill.SetFilter(new DtCardFilter_NameIs_1.DtCardFilter_NameIs(DtCardDigimonType_1.DtCardDigimonType.name_type_10638, true));
...
exports.default = EC_BT7_082_1;
//# sourceMappingURL=EC_BT7_082_1.js.map
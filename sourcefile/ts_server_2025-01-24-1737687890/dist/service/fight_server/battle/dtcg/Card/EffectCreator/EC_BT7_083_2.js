...
class EC_BT7_083_2 extends DtEnhanceEffectCreatorts_1.default {
    SetEffect() {
    ...
    OnCommonAreaSetFilter(mcFliter) {
        mcFliter.SetFilter(new DtCardFilter_Custom_1.DtCardFilter_Custom(this, (card) => {
            if (card.NameIs(DtCardDigimonType_1.DtCardDigimonType.name_type_10881, true) || card.NameIs(DtCardDigimonType_1.DtCardDigimonType.name_type_10882, true)) {
                return false;
            }
...
exports.default = EC_BT7_083_2;
//# sourceMappingURL=EC_BT7_083_2.js.map
...
class EC_BT7_085_2 extends DtEnhanceEffectCreatorts_1.default {
    SetEffect() {
    ...
    Effect2(effect) {
        ...
        skill.SetFilter(new DtCardFilter_NameIs_1.DtCardFilter_NameIs(DtCardDigimonType_1.DtCardDigimonType.name_type_10761, true));
        skill.SetOperate(new DtCardOperate_SeenForceEvo_toParent_1.DtCardOperate_SeenForceEvo_toParent(DtEnum_1.DtCardColor.Red, 5));
    }
}
exports.default = EC_BT7_085_2;
//# sourceMappingURL=EC_BT7_085_2.js.map
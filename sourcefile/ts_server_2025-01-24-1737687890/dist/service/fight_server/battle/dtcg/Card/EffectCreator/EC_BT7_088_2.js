...
class EC_BT7_088_2 extends DtGroupBrowseCardsCreator_1.default {
    group;
    SetEffect() {
        ...
        this.group = this.CheckALLSelfDefense(effect, 1, (skill, idx) => {
            ...
            skill.SetFilter(new DtCardFilter_Custom_1.DtCardFilter_Custom(this, (card) => {
                return card.FeatureIs(DtCardDigimonType_1.DtCardDigimonType.type_505) || card.FeatureIs(DtCardDigimonType_1.DtCardDigimonType.type_137);
            }));
...
exports.default = EC_BT7_088_2;
//# sourceMappingURL=EC_BT7_088_2.js.map
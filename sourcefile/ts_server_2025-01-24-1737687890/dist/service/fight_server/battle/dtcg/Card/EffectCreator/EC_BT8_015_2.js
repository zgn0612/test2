...
class EC_BT8_015_2 extends DtEnhanceEffectCreatorts_1.default {
    SetEffect() {
        let effect = this.GetNewEffect();
        effect.SetTriggerType(DtEffectType_1.DtEffectType.OnEvolution);
        this.Skill1(effect);
        effect.SetEffect(this.Over, null);
        this.Skill2(effect);
    }
    Skill1(effect) {
...
exports.default = EC_BT8_015_2;
//# sourceMappingURL=EC_BT8_015_2.js.map
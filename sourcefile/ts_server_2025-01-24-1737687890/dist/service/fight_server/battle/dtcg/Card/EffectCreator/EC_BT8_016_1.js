...
class EC_BT8_016_1 extends DtEffectCreator_1.DtEffectCreator {
    SetEffect() {
    ...
    BuffCon(buff, card) {
        if (card.CardTypeIs(DtEnum_1.DtCardType.Monster) && card.NameIs(DtCardDigimonType_1.DtCardDigimonType.name_type_10105)) {
            return 1;
        }
        return 0;
    }
}
exports.default = EC_BT8_016_1;
//# sourceMappingURL=EC_BT8_016_1.js.map
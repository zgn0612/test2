...
class EC_BT8_021_1 extends DtGroupBrowseCardsCreator_1.default {
    SetEffect() {
        ...
        this.SetCommonBrowseFromDeckThenBottom(effect, 4, 1, (skill, idx) => {
            ...
            skill.SetFilter(new DtCardFilter_CardColorCount_1.DtCardFilter_CardColorCount(DtEnum_1.DtFilterCompare.GREATE_EQUAL, 2));
            skill.SetOperate(new DtCardOperate_MoveTo_Hand_1.DtCardOperate_MoveTo_Hand());
        });
    }
}
exports.default = EC_BT8_021_1;
//# sourceMappingURL=EC_BT8_021_1.js.map
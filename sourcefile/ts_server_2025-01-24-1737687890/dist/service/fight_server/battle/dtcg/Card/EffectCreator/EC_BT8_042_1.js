...
class EC_BT8_042_1 extends DtFusionEffectCreator_1.default {
    SetEffect() {
    ...
    CheckBottomCardCondition(card) {
        return card.CardTypeIs(DtEnum_1.DtCardType.Monster) && card.ColorIs(DtEnum_1.DtCardColor.Blue) && card.CardLvIs(DtEnum_1.DtFilterCompare.EQUAL, 4);
    }
}
exports.default = EC_BT8_042_1;
//# sourceMappingURL=EC_BT8_042_1.js.map
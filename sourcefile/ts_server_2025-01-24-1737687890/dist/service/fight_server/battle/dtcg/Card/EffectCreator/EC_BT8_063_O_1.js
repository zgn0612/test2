...
class EC_BT8_063_O_1 extends DtCreateEffectToSelfCreator_1.default {
    SetEffect() {
    ...
    OnGetEffectCreator() {
        return new EC_EC_BT8_063_O_1_ADD();
    }
}
exports.default = EC_BT8_063_O_1;
class EC_EC_BT8_063_O_1_ADD extends DtEffectCreator_1.DtEffectCreator {
    SetEffect() {
        let effect = this.GetAddEffect();
        this.SetBlockEffect(effect);
    }
}
//# sourceMappingURL=EC_BT8_063_O_1.js.map
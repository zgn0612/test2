...
class EC_BT8_095_1 extends DtEffectCreator_1.DtEffectCreator {
    SetEffect() {
    ...
    con(buff) {
        return this.GetPlayer().areaInBattle.CheckWithCondition((card) => {
            return card.FeatureIs(DtCardDigimonType_1.DtCardDigimonType.type_506) && card.CardTypeIs(DtEnum_1.DtCardType.Monster);
        });
    }
}
exports.default = EC_BT8_095_1;
//# sourceMappingURL=EC_BT8_095_1.js.map
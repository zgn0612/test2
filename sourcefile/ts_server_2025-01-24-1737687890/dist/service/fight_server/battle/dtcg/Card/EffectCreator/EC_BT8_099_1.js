...
class EC_BT8_099_1 extends DtEnhanceEffectCreatorts_1.default {
    SetEffect() {
    ...
    Skill2(effect) {
        let skill = this.SetSkillPlayerChoose_Mul(effect, DtEnum_1.DtSkillTargetToPlayer.Self, 10, 2);
        skill.GetMachineFilter().GetCardsWitchAreaData(DtEnum_1.DtSkillTargetToPlayer.Opponent, DtEnum_1.DtAreaType.BATTLE_AREA);
        skill.SetFilter(new DtCardFilter_CardType_1.DtCardFilter_CardType(DtEnum_1.DtCardType.Monster));
...
exports.default = EC_BT8_099_1;
//# sourceMappingURL=EC_BT8_099_1.js.map
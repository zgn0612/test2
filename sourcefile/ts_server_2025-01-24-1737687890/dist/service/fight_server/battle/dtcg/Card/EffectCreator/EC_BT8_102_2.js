...
class EC_BT8_102_2 extends DtEnhanceEffectCreatorts_1.default {
    SetEffect() {
    ...
    OnCommonAreaSetFilter(mcFliter) {
        mcFliter.SetFilter(new DtCardFilter_CardType_1.DtCardFilter_CardType(DtEnum_1.DtCardType.Monster, DtEnum_1.DtCardType.Role));
    }
    OnCommonAreaSetOperate(mcOperate) {
        mcOperate.SetOperate(new DtCardOperate_ChangeState_1.DtCardOperate_ChangeState(DtEnum_1.DtCardBattleState.Reset));
    }
}
exports.default = EC_BT8_102_2;
//# sourceMappingURL=EC_BT8_102_2.js.map
...
class EC_BT9_017_1 extends DtEnhanceEffectCreatorts_1.default {
    smallDp = 0;
    SetEffect() {
    ...
    skill1(effect) {
        ...
        skill.SetFilter(new DtCardFilter_Custom_1.DtCardFilter_Custom(this, (card) => {
            return card.GetLastDP() == this.smallDp && card.CardTypeIs(DtEnum_1.DtCardType.Monster);
        }));
...
exports.default = EC_BT9_017_1;
//# sourceMappingURL=EC_BT9_017_1.js.map
...
class EC_BT9_020_1 extends DtGroupBrowseCardsCreator_1.default {
    SetEffect() {
        let effect = this.GetNewEffect();
        effect.SetTriggerType(DtEffectType_1.DtEffectType.OnPlay);
        this.SetCommonBrowseFromDeckThenBottom(effect, 3, 2, (skl, idx) => {
            if (idx == 0) {
                skl.SetFilter(new DtCardFilter_MulNameIs_1.DtCardFilter_MulNameIs(false, DtCardDigimonType_1.DtCardDigimonType.name_type_10010, DtCardDigimonType_1.DtCardDigimonType.name_type_10008));
            }
            else {
...
exports.default = EC_BT9_020_1;
//# sourceMappingURL=EC_BT9_020_1.js.map
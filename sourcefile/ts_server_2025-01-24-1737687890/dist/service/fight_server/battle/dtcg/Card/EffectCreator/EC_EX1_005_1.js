...
class EC_EX1_005_1 extends DtEnhanceEffectCreatorts_1.default {
    SetEffect() {
    ...
    Con() {
        let hasRole = this.GetPlayer().areaInBattle.CheckWithCondition((card) => {
            return card.NameIs(DtCardDigimonType_1.DtCardDigimonType.name_type_10515, true);
        });
        return hasRole == false;
    }
    OnCommonAreaSetFilter(mcFliter) {
        mcFliter.SetFilter(new DtCardFilter_NameIs_1.DtCardFilter_NameIs(DtCardDigimonType_1.DtCardDigimonType.name_type_10515, true));
    }
    OnCommonAreaSetOperate(mcOperate) {
        mcOperate.SetOperate(new DtCardOperate_PlayCard_1.DtCardOperate_PlayCard(false, true));
    }
}
exports.default = EC_EX1_005_1;
//# sourceMappingURL=EC_EX1_005_1.js.map
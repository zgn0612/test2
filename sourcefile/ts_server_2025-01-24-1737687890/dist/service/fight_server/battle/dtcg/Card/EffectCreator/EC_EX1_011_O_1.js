...
class EC_EX1_011_O_1 extends DtGroupBrowseCardsCreator_1.default {
    SetEffect() {
        ...
        this.SetCommonBrowseFromDeckThenBottom(effect, 3, 1, (skill, idx) => {
            skill.SetFilter(new DtCardFilter_Custom_1.DtCardFilter_Custom(this, (card) => {
                return card.CardTypeIs(DtEnum_1.DtCardType.Role) || card.NameIs(DtCardDigimonType_1.DtCardDigimonType.name_type_10009);
            }));
            skill.SetOperate(new DtCardOperate_MoveTo_Hand_1.DtCardOperate_MoveTo_Hand());
        });
    }
}
exports.default = EC_EX1_011_O_1;
//# sourceMappingURL=EC_EX1_011_O_1.js.map
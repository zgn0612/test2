...
class EC_EX1_035_1 extends DtEnhanceEffectCreatorts_1.default {
    SetEffect() {
        ...
        skill.SetFilter(new DtCardFilter_Custom_1.DtCardFilter_Custom(this, (card) => {
            if (this.parent.whereAreaType == DtEnum_1.DtAreaType.BATTLE_AREA) {
                if (card.FeatureIs(DtCardDigimonType_1.DtCardDigimonType.type_24)) {
...
exports.default = EC_EX1_035_1;
//# sourceMappingURL=EC_EX1_035_1.js.map
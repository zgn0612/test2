...
class EC_EX1_041_1 extends DtEnhanceEffectCreatorts_1.default {
    SetEffect() {
    ...
    Con() {
        return this.parent.CheckOriginListWithCondition((card) => {
            return card.FeatureIs(DtCardDigimonType_1.DtCardDigimonType.type_512);
        });
    }
...
exports.default = EC_EX1_041_1;
//# sourceMappingURL=EC_EX1_041_1.js.map
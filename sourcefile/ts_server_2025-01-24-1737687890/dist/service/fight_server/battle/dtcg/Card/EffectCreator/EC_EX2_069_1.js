...
class EC_EX2_069_1 extends DtEffectCreator_1.DtEffectCreator {
    SetEffect() {
    ...
    con(buff) {
        return this.GetPlayer().areaInBattle.CheckWithCondition((card) => {
            return card.CardTypeIs(DtEnum_1.DtCardType.Monster) && card.NameIs(DtCardDigimonType_1.DtCardDigimonType.name_type_10276);
        });
    }
}
exports.default = EC_EX2_069_1;
//# sourceMappingURL=EC_EX2_069_1.js.map
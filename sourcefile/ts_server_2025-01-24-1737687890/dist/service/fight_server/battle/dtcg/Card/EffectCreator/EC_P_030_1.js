...
class EC_P_030_1 extends DtEnhanceEffectCreatorts_1.default {
    SetEffect() {
    ...
    OnCommonAreaSetFilter(mcFliter) {
        mcFliter.SetFilter(new DtCardFilter_NameIs_1.DtCardFilter_NameIs(DtCardDigimonType_1.DtCardDigimonType.name_type_10735, true));
        mcFliter.SetFilter(new DtCardFilter_CanIngoreEvoRequire_1.DtCardFilter_CanIngoreEvoRequire());
    }
    OnCommonAreaSetOperate(mcOperate) {
        mcOperate.SetOperate(new DtCardOperate_ForceEvo_tobattleCard_1.DtCardOperate_ForceEvo_tobattleCard(1, this, () => { return this.parent; }));
        mcOperate.SetOperate(new DtCardOperate_SpecialOperate_1.DtCardOperate_SpecialOperate(this, (card, eff) => {
            this.CreateEffectTo(new EC_P_030_1_ADD, this.parent, false);
        }, DtCardOperate_SpecialOperate_1.DtSpecialOpType.ADD_SKILL_BUFF));
    }
}
exports.default = EC_P_030_1;
class EC_P_030_1_ADD extends DtEffectCreator_1.DtEffectCreator {
    SetEffect() {
...
//# sourceMappingURL=EC_P_030_1.js.map
...
class EC_ST6_12_1 extends DtEnhanceEffectCreatorts_1.default {
    SetEffect() {
    ...
    OnCommonAreaSetOperate(mcOperate) {
        mcOperate.SetOperate(new DtCardOperate_SpecialOperate_1.DtCardOperate_SpecialOperate(this, (card, eff) => {
            this.CreateEffectTo(new EC_ST6_12_1_Add(), card, false);
        }, DtCardOperate_SpecialOperate_1.DtSpecialOpType.ADD_SKILL_BUFF));
    }
}
exports.default = EC_ST6_12_1;
class EC_ST6_12_1_Add extends DtEffectCreator_1.DtEffectCreator {
    SetEffect() {
...
//# sourceMappingURL=EC_ST6_12_1.js.map
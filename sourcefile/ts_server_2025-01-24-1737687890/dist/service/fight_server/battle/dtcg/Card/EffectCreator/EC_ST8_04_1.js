...
class EC_ST8_04_1 extends DtEffectCreator_1.DtEffectCreator {
    SetEffect() {
    ...
    BuffCon(buff, card) {
        ...
        if (card.NameIs(DtCardDigimonType_1.DtCardDigimonType.name_type_10117, true)) {
            return 4;
        }
        return -1;
    }
}
exports.default = EC_ST8_04_1;
//# sourceMappingURL=EC_ST8_04_1.js.map